...
/* Command prompt line */
#define PROMPTLINE ">\x1B[K" /* \x1B[K - clear screen after cursor */

/* TODO translate comments */
#define UART_RX_BUFF_SIZE		32	// Ðàçìåð áóôåðà ïðèåìà UART
#define UART_TX_BUFF_SIZE		32	// Ðàçìåð áóôåðà ïðèåìà UART
#define UART_RX_HISTORY_SIZE	5	// Ðàçìåð áóôåðà ïðèåìà UART
...
unsigned char n_butes;	// Ñ÷åò÷èê ïðèíÿòûõ ïî UART áàéò
...
#define UART_escape_chain_bit 	4 /* Escape chain flag */
